...
CREATE TABLE IF NOT EXISTS `topic` (
    ...
    `热度_score` INT DEFAULT 0 COMMENT '热度评分',
...
CREATE INDEX idx_message_from_user ON message(from_user_id);
CREATE INDEX idx_message_to_user ON message(to_user_id);
CREATE INDEX idx_hot_search_rank ON hot_search(rank);
CREATE INDEX idx_topic_heat ON topic(热度_score);
